...
const filme = [
    ...
    },
    {
        ...
        descricao: "Garfield (dublado por Chris Pratt), o gato doméstico mundialmente famoso, que odeia segundas-feiras e adora lasanha, está prestes a ter uma aventura selvagem ao ar livre. Após um reencontro inesperado com seu pai há muito perdido - o gato de rua desleixado Vic (dublado por Samuel L. Jackson) - Garfield e seu amigo canino Odie são forçados a deixar sua vida perfeitamente mimada para se juntar a Vic em um assalto hilário e arriscado.", 
        capa: "./img/Garfield.jfif",
        genero: 2
    },
]